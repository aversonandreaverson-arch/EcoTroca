...
// A empresa não pode publicar oferta_residuo — só utilizadores comuns
const TIPOS_EMPRESA = [
...
// Filtros do feed — iguais à PaginaInicial do utilizador comum
const FILTROS = [
...
// Estilos visuais por tipo de publicação — iguais à PaginaInicial
const ESTILOS = {
...
// Formulário vazio — tipo padrão da empresa é pedido_residuo
const FORM_VAZIO = {
...
// Cartão individual de publicação — igual à PaginaInicial do utilizador comum
