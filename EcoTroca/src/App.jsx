...
import Rankings       from './Components/UserProfile/Rankings'
...
import RecolhasAgendadas      from './Components/ColetadorProfile/RecolhasAgendadas'
...
function App() {
  return (
    <Routes>
      ...
      <Route path='/Rankings'          element={<RotaProtegida><Rankings /></RotaProtegida>} />
      ...
      <Route path='/RecolhasAgendadas'   element={<RotaProtegida tipos={["coletor"]}><RecolhasAgendadas /></RotaProtegida>} />
