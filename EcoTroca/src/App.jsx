...
import RecolhasAgendadas      from './Components/ColetadorProfile/RecolhasAgendadas' // ✅ NOVO - Recolhas agendadas
...
function App() {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path='/RecolhasAgendadas'   element={<RotaProtegida tipos={["coletor"]}><RecolhasAgendadas /></RotaProtegida>} /> {/* ✅ NOVO */}
